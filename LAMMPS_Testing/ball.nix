...
EOF
    ...
    substituteInPlace source/FORMAT/PDBFileDetails.C --replace 'boost::shared_ptr<PersistentObject> temp_ptr(new CrystalInfo());' 'const boost::shared_ptr<PersistentObject> temp_ptr(new CrystalInfo());'
  '';

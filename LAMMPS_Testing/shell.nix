...
mkShell {
  buildInputs = [
    (callPackage ./lammps.nix {withMPI = true; fetchPypi=pythonPackages.fetchPypi; buildPythonPackage=pythonPackages.buildPythonPackage;
                               intelCompilers=nur.repos.dguibert.intelPackages_2020_4_304.compilers; # More info: https://github.com/dguibert/nur-packages/blob/master/overlays/intel-compilers-overlay/default.nix
                              }) #lammps
  ];
}

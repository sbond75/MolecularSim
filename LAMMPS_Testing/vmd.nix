{ lib, stdenv, fetchFromGitHub, fetchurl, gnumake, perl, libGL, fltk, tk-8_5, tcl-8_5, xorg, withCuda ? true, cudatoolkit, linuxPackages, tcsh, bison, xterm, imagemagick, binutils, gnuplot, latex2html, last, python, python27,
...
cp $prog ../binaries' #'cp $prog.intel64 ../binaries/$(basename "$prog")' # TODO: support more architectures than intel64. It attempts to make a macOS "fat" binary with `lipo`, even including the PowerPC architecture.
    ...
    patchShebangs vmd-1.9.3/lib/scripts/tcl8.5/ldAix
    patchShebangs vmd-1.9.3/lib/scripts/tk8.5/demos/tcolor
    patchShebangs vmd-1.9.3/lib/scripts/tk8.5/demos/browse
    patchShebangs vmd-1.9.3/lib/scripts/tk8.5/demos/rolodex
    patchShebangs vmd-1.9.3/lib/scripts/tk8.5/demos/timer
    patchShebangs vmd-1.9.3/lib/scripts/tk8.5/demos/square
    patchShebangs vmd-1.9.3/lib/scripts/tk8.5/demos/widget
    patchShebangs vmd-1.9.3/lib/scripts/tk8.5/demos/rmt
    patchShebangs vmd-1.9.3/lib/scripts/tk8.5/demos/hello
    patchShebangs vmd-1.9.3/lib/scripts/tk8.5/demos/ixset
  ...
  postConfigure = ''
    ...
    substituteInPlace vmd-${version}/src/Makefile --replace "/usr/local/lib/vmd" "$out/lib" --replace '	if [ ! -d "/usr/local/bin" ]; then \

...
stdenv.mkDerivation rec {
  ...
  patchPhase = ''
    substituteInPlace CMakeLists.txt --replace 'file(COPY test_data DESTINATION ''${CMAKE_CURRENT_BINARY_DIR})' 'message(file(COPY ''${CMAKE_CURRENT_SOURCE_DIR}/test_data DESTINATION '"$out))
